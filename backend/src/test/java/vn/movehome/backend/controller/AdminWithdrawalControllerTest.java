...
class AdminWithdrawalControllerTest {
    ...
    private final AdminWithdrawalService service = mock(AdminWithdrawalService.class);
    private final AdminWithdrawalController controller = new AdminWithdrawalController(service);

    @Test
    void getPendingUsesServiceDefaultSizeWhenSizeMissing() {
        PendingWithdrawalPageResponse expected = new PendingWithdrawalPageResponse(
        ...
        PendingWithdrawalPageResponse actual = controller.getPending(0, null);
    ...
    void getPendingUsesProvidedSize() {
        ...
        PendingWithdrawalPageResponse actual = controller.getPending(1, 50);
